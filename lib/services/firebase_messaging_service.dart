...
class FirebaseMessagingService {
  ...
  factory FirebaseMessagingService.instace()=> _instance;
  ...
  Future<void> init({required LocalNotificationsService localNotificationService}) async {
    ...
    //Listen for messages when the app in forground
  ...
  Future<void> _handlePushNotificationsToken()async{
    ...
    //Listen for tken refresh events
    FirebaseMessaging.instance.onTokenRefresh.listen((fcmToken) {
      print('FCM token refreshed: $fcmToken');
      //TODO: optionally send token to your server for targetting this device
    }).onError((error){
  ...
  ///Handle notification taps when app is opened from the background or terminated state
